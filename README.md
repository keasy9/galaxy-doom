...
Сцены и объекты сгруппированы в соответствующих директориях. Если сцену или объект можно полностью описать одним файлом,
он лежит в соответствующей директории. Если сцена или объект требуют дополнительные классы (файлы), например, фабрику
или состояние, сцена (или объект) и связанные файлы группируются во вложенной директории.
